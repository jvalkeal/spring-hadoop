 ...
 *
 */
public interface SpringDataStoreWriterConfigurer extends AnnotationConfigurer<SpringDataStoreWriterConfigs, SpringDataStoreWriterBuilder> {

	/**
	 * Configure {@link Configuration} via {@link DataStoreWriterBuilder} builder.
	 *
	 * @param config the {@link DataStoreWriterConfigurer} builder
	 * @throws Exception if error occurred
	 */
	void configure(DataStoreWriterConfigurer config) throws Exception;
