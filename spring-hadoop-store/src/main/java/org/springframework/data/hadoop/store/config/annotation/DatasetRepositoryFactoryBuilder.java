...
public class DatasetRepositoryFactoryBuilder
		extends
		AbstractConfiguredAnnotationBuilder<SpringDataStoreWriterConfigs, DatasetRepositoryFactoryBuilder, DatasetRepositoryFactoryBuilder> {
