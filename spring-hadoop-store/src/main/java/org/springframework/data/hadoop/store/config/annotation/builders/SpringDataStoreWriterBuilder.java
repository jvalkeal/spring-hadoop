 ...
 *
 */
public class SpringDataStoreWriterBuilder extends
		AbstractConfiguredAnnotationBuilder<SpringDataStoreWriterConfigs, SpringDataStoreWriterBuilder, SpringDataStoreWriterBuilder> {
	...
	protected SpringDataStoreWriterConfigs performBuild() throws Exception {
		...
		BeanDefinition buildWriter = getSharedObject(DataStoreWriterBuilder.class).build();
