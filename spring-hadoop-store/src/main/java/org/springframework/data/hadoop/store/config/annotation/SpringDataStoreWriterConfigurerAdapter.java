...
/**
 * Provides a convenient base class for creating a {@link SpringDataStoreWriterConfigurer}
 * instance. The implementation allows customization by overriding methods.
 *
 * @author Janne Valkealahti
 * @see EnableDataStoreWriter
 *
 */
public class SpringDataStoreWriterConfigurerAdapter implements SpringDataStoreWriterConfigurer {

	private DataStoreWriterBuilder hadoopConfigBuilder;
	...
	@Override
	public final void init(SpringDataStoreWriterBuilder builder) throws Exception {
		builder.setSharedObject(DataStoreWriterBuilder.class, getConfigBuilder());
	}

	@Override
	public void configure(SpringDataStoreWriterBuilder builder) throws Exception {
	}
...
//	@Autowired(required=false)
	...
	protected final DataStoreWriterBuilder getConfigBuilder() throws Exception {
		if (hadoopConfigBuilder != null) {
			return hadoopConfigBuilder;
		}
//		hadoopConfigBuilder = new DataStoreWriterBuilder();
		hadoopConfigBuilder = new DataStoreWriterBuilder(objectPostProcessor);
