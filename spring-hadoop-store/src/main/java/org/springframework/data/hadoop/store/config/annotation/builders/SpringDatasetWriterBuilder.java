...
public class SpringDatasetWriterBuilder
		extends
		AbstractConfiguredAnnotationBuilder<SpringDataStoreWriterConfigs, SpringDatasetWriterBuilder, SpringDatasetWriterBuilder> {
	...
	protected SpringDataStoreWriterConfigs performBuild() throws Exception {
		...
		BeanDefinition buildWriter = getSharedObject(DatasetWriterBuilder.class).build();
