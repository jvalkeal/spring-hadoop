...
import org.springframework.data.hadoop.store.config.annotation.configuration.SpringDataStoreWriterConfiguration;

@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
@Documented
@EnableAnnotationConfiguration
@Import({SpringDataStoreWriterConfiguration.class, ObjectPostProcessorConfiguration.class})
public @interface EnableDataStoreWriter {
