 ...
 *
 */
public final class DataStoreWriterBuilder
		extends
		AbstractConfiguredAnnotationBuilder<BeanDefinition, DataStoreWriterConfigurer, DataStoreWriterBuilder>
		implements DataStoreWriterConfigurer {
	 ...
	 */
	public DataStoreWriterBuilder(ObjectPostProcessor<Object> objectPostProcessor) {
	...
	@Override
	public DataStoreWriterConfigurer configuration(Configuration configuration) {
		this.configuration = configuration;
		return this;
	}

	@Override
	public DataStoreWriterConfigurer basePath(Path basePath) {
		this.basePath = basePath;
		return this;
	}

	@Override
	public DataStoreWriterConfigurer basePath(String basePath) {
		return basePath(new Path(basePath));
	}

	@Override
	public DataStoreWriterConfigurer codec(CodecInfo codec) {
		this.codec = codec;
		return this;
	}

	@Override
	public DataStoreWriterConfigurer codec(String codec) {
		return codec(Codecs.getCodecInfo(codec));
	}

	@Override
	public DataStoreWriterConfigurer codec(Codecs codec) {
		return codec(codec.getCodecInfo());
	}

	@Override
	public DataStoreWriterConfigurer overwrite(boolean overwrite) {
		this.overwrite = overwrite;
		return this;
	}

	@Override
	public DataStoreWriterConfigurer inWritingPrefix(String prefix) {
		this.inWritingPrefix = prefix;
		return this;
	}

	@Override
	public DataStoreWriterConfigurer inWritingSuffix(String suffix) {
		this.inWritingSuffix = suffix;
		return this;
	}

	@Override
	public DataStoreWriterConfigurer idleTimeout(long timeout) {
		this.idleTimeout = timeout;
		return this;
	}

	@Override
	public DataStoreWriterConfigurer fileOpenAttempts(int attempts) {
