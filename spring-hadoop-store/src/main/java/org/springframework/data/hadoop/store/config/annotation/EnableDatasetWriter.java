...
import org.springframework.data.hadoop.store.config.annotation.configuration.SpringDatasetWriterConfiguration;

@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
@Documented
@EnableAnnotationConfiguration
@Import({SpringDatasetWriterConfiguration.class, ObjectPostProcessorConfiguration.class})
public @interface EnableDatasetWriter {
