...
public class DatasetDefinitionBuilder
		extends
		AbstractConfiguredAnnotationBuilder<SpringDataStoreWriterConfigs, DatasetDefinitionBuilder, DatasetDefinitionBuilder> {
