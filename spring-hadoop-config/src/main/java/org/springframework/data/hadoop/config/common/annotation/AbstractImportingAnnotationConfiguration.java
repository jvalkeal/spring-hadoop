...
public abstract class AbstractImportingAnnotationConfiguration<B extends AnnotationBuilder<O>, O> implements
	...
	/**
	 * Called with a specific annotation configurers.
	 *
	 ...
	 */
	protected abstract void onConfigurers(BeanDefinitionRegistry registry, String[] names,
			List<AnnotationConfigurer<O, B>> configurers) throws Exception;
