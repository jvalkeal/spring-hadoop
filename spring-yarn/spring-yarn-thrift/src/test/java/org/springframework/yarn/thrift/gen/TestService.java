 ...
 *  @generated
 */
package org.springframework.yarn.thrift.gen;
...
public class TestService {
  ...
  public interface Iface {
    ...
    public long add(int number1, int number2) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void add(int number1, int number2, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.add_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_add(int number1, int number2) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void add(int number1, int number2, org.apache.thrift.async.AsyncMethodCallback<add_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      add_call method_call = new add_call(number1, number2, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class add_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int number1;
      private int number2;
      public add_call(int number1, int number2, org.apache.thrift.async.AsyncMethodCallback<add_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class add<I extends Iface> extends org.apache.thrift.ProcessFunction<I, add_args> {
      ...
      public add_result getResult(I iface, add_args args) throws org.apache.thrift.TException {
        add_result result = new add_result();
        result.success = iface.add(args.number1, args.number2);
  ...
  public static class add_args implements org.apache.thrift.TBase<add_args, add_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public add_args setNumber1(int number1) {
      this.number1 = number1;
      setNumber1IsSet(true);
      return this;
    }
    ...
    public add_args setNumber2(int number2) {
      this.number2 = number2;
      setNumber2IsSet(true);
      return this;
    }
    ...
    public int compareTo(add_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetNumber1()).compareTo(typedOther.isSetNumber1());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetNumber1()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.number1, typedOther.number1);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
      lastComparison = Boolean.valueOf(isSetNumber2()).compareTo(typedOther.isSetNumber2());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetNumber2()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.number2, typedOther.number2);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
